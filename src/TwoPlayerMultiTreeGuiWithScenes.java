...
public class TwoPlayerMultiTreeGuiWithScenes extends DefaultGUI implements Serializable {
	...
	public TwoPlayerMultiTreeGuiWithScenes(long numControllerRequests, long firstUsableCycle, TwoPlayerMultiTreeControllerWithScenes controller, long[] startOnOffTimes, Clock clock)
	{
	...
	public TwoPlayerMultiTreeControllerWithScenes getController()
	{
		return controller;
	}
	
	public void setController(TwoPlayerMultiTreeControllerWithScenes controller)
	{
		this.controller = controller;
	}
