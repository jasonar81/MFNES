...
public class BubbleBobble2DecisionTree implements AiAgent {
	private Clock clock;
	private CPU cpu;
	private PPU ppu;
	private APU apu;
	...
	private static BubbleBobble2DecisionTree instance;
	...
	{
		instance = new BubbleBobble2DecisionTree();
		instance.main();
	}
	...
	private boolean loadTree()
	{
		try
		{
			File file = new File("bubble_bobble2.tree");
			if (!file.exists())
			{
				return false;
			}
	...
	private boolean loadTree2()
	{
		try
		{
			File file = new File("bubble_bobble2.tree2");
			if (!file.exists())
			{
				return false;
			}
