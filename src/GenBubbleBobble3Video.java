...
public class GenBubbleBobble3Video implements AiAgent {
	private Clock clock;
	private CPU cpu;
	private PPU ppu;
	private APU apu;
	...
	private static GenBubbleBobble3Video instance;
	...
	{
		instance = new GenBubbleBobble3Video();
		String dir = args[0];
		String ts = args[1];
	...
	{	
		...
		//Run
		loadNet(dir + "bubble_bobble_pixels" + ts + ".net");
		setup();
	...
	private void setup()
	{
		...
		long[] startOnOffTimes = new long[] {3551418, 4298614, 15538630, 16164028, 17682829, 18130489,
				...
				45561100, 46095082};
		clock = new Clock();
		gui = new RecordingNetGui(false, numControllerRequests, firstUsableCycle, net, startOnOffTimes, clock, dir + "bubble_bobble_pixels" + ts + ".mp4");
