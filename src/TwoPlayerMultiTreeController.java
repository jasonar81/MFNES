...
public class TwoPlayerMultiTreeController implements Serializable {
	private static final long serialVersionUID = -6732487624928621347L;
	Memory cpuMem;
	private transient TwoPlayerMultiDecisionTree tree;
	...
	public TwoPlayerMultiTreeController(TwoPlayerMultiDecisionTree tree)
	{	
		this.tree = tree;
	}
	
	public void setTree(TwoPlayerMultiDecisionTree tree)
	{
		this.tree = tree;
	}
