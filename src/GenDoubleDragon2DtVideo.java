...
public class GenDoubleDragon2DtVideo implements AiAgent {
	private Clock clock;
	private CPU cpu;
	private PPU ppu;
	private APU apu;
	...
	private static GenDoubleDragon2DtVideo instance;
	...
	public static void main(String[] args)
	{
		...
		instance = new GenDoubleDragon2DtVideo();
		instance.main();
	}
	...
	private boolean loadTree()
	{
		try
		{
			File file = new File(dir + "double_dragon2" + ts + ".tree");
			if (!file.exists())
			{
				return false;
			}
	...
	private void setup()
	{
		...
		clock = new Clock();
		gui = new RecordingDecisionTreeGui(numControllerRequests, firstUsableCycle, controller, startOnOffTimes, clock, dir + "double_dragon2_dt" + ts + ".mp4");
