...
public class GenAdventureIsland32Video implements AiAgent {
	private Clock clock;
	private CPU cpu;
	private PPU ppu;
	private APU apu;
	...
	private static GenAdventureIsland32Video instance;
	...
	{
		instance = new GenAdventureIsland32Video();
		String dir = args[0];
		String ts = args[1];
	...
	{	
		...
		//Run
		loadNet(dir + "adventure_island3" + ts + ".net");
		setup();
	...
	private void setup()
	{
		...
		clock = new Clock();
		gui = new RecordingNetGui(true, numControllerRequests, firstUsableCycle, net, startOnOffTimes, clock, dir + "adventure_island3_memory" + ts + ".mp4");
