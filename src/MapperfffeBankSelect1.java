...
public class MapperfffeBankSelect1 implements MemoryPort {
	...
	public MapperfffeBankSelect1(Memory cpuMem, MemoryPort delegate, boolean high)
	{
		this.cpuMem = cpuMem;
	...
	public void write(byte val) {
		...
		else
		{
			...
			cpuMem.loadRomAtAddressMapperfffe(cpuMem.getCart().prgData(), 0xc000, bank * 16384, 16384);
		}
	}
