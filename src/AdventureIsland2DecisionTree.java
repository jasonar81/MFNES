...
public class AdventureIsland2DecisionTree implements AiAgent {
	...
	private boolean loadTree2()
	{
		try
		{
			File file = new File("adventure_island2.tree2");
			if (!file.exists())
			{
				return false;
			}
	...
	private void makeModifications()
	{
		...
		cpu.getMem().getLayout()[0xd0] = new NotifyChangesPort(this, clock); //world
		cpu.getMem().getLayout()[0xd1] = new NotifyChangesPort(this, clock); //level
