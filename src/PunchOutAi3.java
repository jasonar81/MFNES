...
public class PunchOutAi3 implements AiAgent {
	private Clock clock;
	private CPU cpu;
	private PPU ppu;
	private APU apu;
	...
	private static PunchOutAi3 instance;
	...
	private void saveNet()
	{
		try
		{
			FileWriter file = new FileWriter("punch_out_pixels.net");
	...
	private boolean loadNet()
	{
		try
		{
			File file = new File("punch_out_pixels.net");
			if (!file.exists())
			{
				return false;
			}
