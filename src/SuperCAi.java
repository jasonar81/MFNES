...
public class SuperCAi implements AiAgent {
	private Clock clock;
	private CPU cpu;
	private PPU ppu;
	private APU apu;
	...
	private static SuperCAi instance;
	
	private long firstUsableCycle = 56477303;
	
	public static void main(String[] args)
	{
		instance = new SuperCAi();
		instance.main();
	}
	...
	private void main()
	{
		while (true)
		{
			...
			makeModifications();
			ArrayList<ControllerEvent> eventList = getEventList("superc.rec");
			...
			writeCurrentBestRecording(eventList, totalTime, "superc.rec");
			...
			while (!improved)
			{
				...
				eventList = getEventList("superc.rec");
	...
	private void makeModifications()
	{
		...
		cpu.getMem().getLayout()[0x53] = new NotifyChangesPort(this, clock, (byte)4); //Lives remaining
	}
