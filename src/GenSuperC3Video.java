...
public class GenSuperC3Video implements AiAgent {
	private Clock clock;
	private CPU cpu;
	private PPU ppu;
	private APU apu;
	...
	private static GenSuperC3Video instance;
	...
	{	
		...
		loadNet(dir + "superc_pixels" + ts + ".net");
		setup();
	...
	private void setup()
	{
		...
		clock = new Clock();
		gui = new RecordingNetGui(false, numControllerRequests, firstUsableCycle, net, startOnOffTimes, clock, dir + "superc_pixels" + ts + ".mp4");
