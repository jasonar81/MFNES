...
public class GenDoubleDragon22Video implements AiAgent {
	private Clock clock;
	private CPU cpu;
	private PPU ppu;
	private APU apu;
	...
	private static GenDoubleDragon22Video instance;
	...
	{
		instance = new GenDoubleDragon22Video();
		String dir = args[0];
		String ts = args[1];
	...
	{	
		...
		//Run
		loadNet(dir + "double_dragon2" + ts + ".net");
		setup();
	...
	private void setup()
	{
		...
		clock = new Clock();
		gui = new RecordingNetGui(false, numControllerRequests, firstUsableCycle, net, startOnOffTimes, clock, dir + "double_dragon2_memory" + ts + ".mp4");
