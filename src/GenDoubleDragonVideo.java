...
public class GenDoubleDragonVideo implements AiAgent {
	private Clock clock;
	private CPU cpu;
	private PPU ppu;
	private APU apu;
	...
	private static GenDoubleDragonVideo instance;
	...
	{
		instance = new GenDoubleDragonVideo();
		String dir = args[0];
		String ts = args[1];
	...
	{	
		...
		makeModifications();
		ArrayList<ControllerEvent> eventList = getEventList(dir + "double_dragon" + ts + ".rec");
	...
	private void setup()
	{
		...
		startedDone = false;
		gui = new RecordingGui(dir + "double_dragon" + ts + ".mp4");
