...
public class BubbleBobbleMultiTreeScenes implements AiAgent {
	private Clock clock;
	private CPU cpu;
	private PPU ppu;
	private APU apu;
	...
	private static BubbleBobbleMultiTreeScenes instance;
	...
	{
		instance = new BubbleBobbleMultiTreeScenes();
		instance.main();
	}
