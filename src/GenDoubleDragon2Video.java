...
public class GenDoubleDragon2Video implements AiAgent {
	private Clock clock;
	private CPU cpu;
	private PPU ppu;
	private APU apu;
	...
	private static GenDoubleDragon2Video instance;
	...
	{
		instance = new GenDoubleDragon2Video();
		String dir = args[0];
		String ts = args[1];
	...
	{	
		...
		loadNet(dir + "double_dragon" + ts + ".net");
		setup();
	...
	private void setup()
	{
		...
		clock = new Clock();
		gui = new RecordingNetGui(false, numControllerRequests, firstUsableCycle, net, startOnOffTimes, clock, dir + "double_dragon_memory" + ts + ".mp4");
