...
public class RecordingNetGui extends NetGui {
	private String outputFilename;
	private int frameNum = 0;
	private boolean ready = false;
	private ArrayList<File> files = new ArrayList<File>();
	
	public RecordingNetGui(boolean allButtons, long numControllerRequests, long firstUsableCycle, ControllerNeuralNet cnn, long[] startOnOffTimes, Clock clock, String outputFilename)
	{
		super(allButtons, numControllerRequests, firstUsableCycle, cnn, startOnOffTimes, clock);
