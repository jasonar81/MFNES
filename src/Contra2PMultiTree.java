...
public class Contra2PMultiTree implements AiAgent{
	private Clock clock;
	private CPU cpu;
	private PPU ppu;
	private APU apu;
	...
	private static Contra2PMultiTree instance;
	...
	{
		instance = new Contra2PMultiTree();	
		instance.main();
	}
	...
	private void main()
	{
		...
		if (!loadTree())
		{
			...
			tree = new TwoPlayerMultiDecisionTree(validStates, addresses, defaultTree, disallow);
		}
