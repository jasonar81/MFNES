...
public class DoubleDragonAi3 implements AiAgent {
	private Clock clock;
	private CPU cpu;
	private PPU ppu;
	private APU apu;
	...
	private static DoubleDragonAi3 instance;
	...
	private void saveNet()
	{
		try
		{
			FileWriter file = new FileWriter("double_dragon_pixels.net");
	...
	private boolean loadNet()
	{
		try
		{
			File file = new File("double_dragon_pixels.net");
			if (!file.exists())
			{
				return false;
			}
