...
public class GenContra3Video implements AiAgent {
	private Clock clock;
	private CPU cpu;
	private PPU ppu;
	private APU apu;
	...
	private static GenContra3Video instance;
	
	public static void main(String[] args)
	{
		instance = new GenContra3Video();
		String dir = args[0];
		String ts = args[1];
	...
	{	
		...
		//Run
		loadNet(dir + "contra_pixels" + ts + ".net");
	...
	private void setup()
	{
		...
		gui = new RecordingNetGui(false, numControllerRequests, firstUsableCycle, net, startOnOffTimes, clock, dir + "contra_pixels" + ts + ".mp4");
