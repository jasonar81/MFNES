...
public class GenAdventureIsland2DtVideo implements AiAgent {
	private Clock clock;
	private CPU cpu;
	private PPU ppu;
	private APU apu;
	...
	private static GenAdventureIsland2DtVideo instance;
	...
	public static void main(String[] args)
	{
		...
		instance = new GenAdventureIsland2DtVideo();
		instance.main();
	}
	...
	private boolean loadTree()
	{
		try
		{
			File file = new File(dir + "adventure_island2" + ts + ".tree");
			if (!file.exists())
			{
				return false;
			}
	...
	private void setup()
	{
		...
		clock = new Clock();
		gui = new RecordingDecisionTreeGui(numControllerRequests, firstUsableCycle, controller, startOnOffTimes, clock, dir + "adventure_island2_dt" + ts + ".mp4");
