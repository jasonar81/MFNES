...
public class GenSuperCVideo implements AiAgent {
	private Clock clock;
	private CPU cpu;
	private PPU ppu;
	private APU apu;
	...
	private static GenSuperCVideo instance;
	...
	{	
		...
		makeModifications();
		ArrayList<ControllerEvent> eventList = getEventList(dir + "superc" + ts + ".rec");
	...
	private void setup()
	{
		...
		startedDone = false;
		clock = new Clock();
		gui = new RecordingGui(dir + "superc" + ts + ".mp4");
