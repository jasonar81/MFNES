...
public class TwoPlayerMultiTreeGui extends DefaultGUI implements Serializable {
	...
	public TwoPlayerMultiTreeGui(long numControllerRequests, long firstUsableCycle, TwoPlayerMultiTreeController controller, long[] startOnOffTimes, Clock clock)
	{
	...
	public TwoPlayerMultiTreeController getController()
	{
		return controller;
	}
	
	public void setController(TwoPlayerMultiTreeController controller)
	{
		this.controller = controller;
	}
