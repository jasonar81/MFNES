...
public class GenBubbleBobble2Video implements AiAgent {
	private Clock clock;
	private CPU cpu;
	private PPU ppu;
	private APU apu;
	...
	private static GenBubbleBobble2Video instance;
	...
	{
		instance = new GenBubbleBobble2Video();
		String dir = args[0];
		String ts = args[1];
	...
	{	
		...
		//Run
		loadNet(dir + "bubble_bobble" + ts + ".net");
		setup();
	...
	private void setup()
	{
		...
		long[] startOnOffTimes = new long[] {3551418, 4298614, 15538630, 16164028, 17682829, 18130489,
				...
				45561100, 46095082};
		clock = new Clock();
		gui = new RecordingNetGui(false, numControllerRequests, firstUsableCycle, net, startOnOffTimes, clock, dir + "bubble_bobble_memory" + ts + ".mp4");
