...
public class MapperffffBankSelect2 implements MemoryPort {
	...
	public MapperffffBankSelect2(Memory cpuMem, MemoryPort delegate, boolean high)
	{
	...
	public void write(byte val) {
		...
		else
		{
			...
			ppuMem.loadRomAtAddress(ppuMem.getCart().chrData(), 0, bank * 8192, 8192);
		}
	}
