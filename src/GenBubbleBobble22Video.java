...
public class GenBubbleBobble22Video implements AiAgent {
	private Clock clock;
	private CPU cpu;
	private PPU ppu;
	private APU apu;
	...
	private static GenBubbleBobble22Video instance;
	...
	{
		instance = new GenBubbleBobble22Video();
		String dir = args[0];
		String ts = args[1];
	...
	{	
		...
		//Run
		loadNet(dir + "bubble_bobble2" + ts + ".net");
		setup();
	...
	private void setup()
	{
		...
		clock = new Clock();
		gui = new RecordingNetGui(false, numControllerRequests, firstUsableCycle, net, startOnOffTimes, clock, dir + "bubble_bobble2_memory" + ts + ".mp4");
