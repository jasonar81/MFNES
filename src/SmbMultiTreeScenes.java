...
public class SmbMultiTreeScenes implements AiAgent {
	private Clock clock;
	private CPU cpu;
	private PPU ppu;
	private APU apu;
	...
	private static SmbMultiTreeScenes instance;
	...
	public static void main(String[] args)
	{
		...
		instance = new SmbMultiTreeScenes();
		instance.main();
	}
	...
	private void setup(Snapshot snap)
	{
		...
		((NotifyChangesPort)cpu.getMem().getLayout()[0x71a]).setAgent(this); 
		((NotifyChangesPort)cpu.getMem().getLayout()[0x75a]).setAgent(this);
	...
	public synchronized void progress(long cycle)
	{
		...
		if (cpu.getMem().getLayout()[0x75a].read() == 1)
		{
			setDone(cycle);
			return;
		}
